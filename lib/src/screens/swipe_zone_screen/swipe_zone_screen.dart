...
class SwipeZoneScreen extends StatefulWidget {
  const SwipeZoneScreen({super.key});

  @override
  State<SwipeZoneScreen> createState() => _SwipeZoneScreenState();
}

enum _MiddleIconType { like, dislike, none }

class _SwipeZoneScreenState extends State<SwipeZoneScreen>
  ...
  late _MiddleIconType showingIcon;

  @override
  void initState() {
    super.initState();
    showingIcon = _MiddleIconType.none;
              ...
              child: TinderSwapCard(
                ...
                cardBuilder: (context, index) => Card(
                  child: Stack(
                    children: [
                      ...
                      if (showingIcon == _MiddleIconType.dislike)
                        Center(
                          child: Container(
                      ...
                      if (showingIcon == _MiddleIconType.like)
                        Center(
                          child: Container(
                            padding: const EdgeInsets.all(15),
                            decoration: BoxDecoration(
                      ...
                      ProgressBarIndicator(length: images.length, index: index),
                      Positioned(
                        bottom: 20,
                        left: 10,
                        right: 10,
                ...
                swipeUpdateCallback: (dragUpdateDetails, alignment) {
                  setState(() {
                    if (alignment.x < -0.5) {
                      // Swiping left
                      showingIcon = _MiddleIconType.dislike;
                    } else if (alignment.x > 0.5) {
                      // Swiping right
                      showingIcon = _MiddleIconType.like;
                      /*
                      heartOverlayController.showIcon(
                        offset: Offset(
