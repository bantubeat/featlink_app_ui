...
import 'package:featlink_app/src/components/message_input.dart';
import 'package:featlink_app/src/components/message_bubble.dart';
...
class ConversationScreen extends StatelessWidget {
  ...
  static  List<Map<String, dynamic>> messages = [
    ...
    {
      'message':
          LocaleKeys.conversation_message_4.tr(),
      'isSentByMe': false,
    ...
    return Scaffold(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Icon(Icons.circle, color: AppColors.primary, size: 7.0),
                  ],
                ),
              ],
            ),
      ...
      body: Stack(
        ...
        children: [
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [Colors.white, Color.fromARGB(144, 255, 255, 255)],
          ...
          const Positioned(
            bottom: 0, // Position the container at the top
            left: 0,
            right: 0,
            child: MessageInput(),
          ),
